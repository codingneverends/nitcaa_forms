...
function Begin(bo) {
    ...
    App.sethtml(`
    <div class="dfc">
        <div class="introbox">2021-22
            <h2>Alumni/Mentor Sign-up NITCAA <br> Mentoring Program (NITCAMP) </h2>
...
<br>- If you have questions or would like to know more about NITCAMP, send an email to <a href="mailto:nitcaa.mentoring@gmail.com">nitcaa.mentoring@gmail.com</a> or post in <a href="https://www.facebook.com/groups/nitcaa.mentoring">https://www.facebook.com/groups/nitcaa.mentoring</a>
                <div class="dfc">
                    <button onclick="StartB()">Back</button>
                    <button onclick="NamePage()">Continue</button>
                </div>
...
function SetName(bo = false) {
    ...
    App.sethtml(`
        <div class="dfc">
            <div class="introbox">
                Hey <sp>${name}</sp> <br>  Enter email id and phone number ${ismentor?`graduation year at NITC/REC and how many mentees you can hold.`:`year of study(eg - 3rd yr) and NITC Roll number`}   .
                <br>
                <br>
...
function SetMandP(bo = false) {
    if (!bo) {
        ...
        if(ismentor && (!_max_hold || _max_hold==undefined || _max_hold==null) || _max_hold.match(/^[0-9]+([0-9]+)*$/)==null){
...
function NarrowArea(bo = false) {
    ...
    App.sethtml(`
        <div class="dfc">
            <div class="introbox">
                Choose your narrow areas of expertise
                <br>
                <br>
                <div id="cus_add">
                ${p_adds}
...
function Search(val) {
    ...
    for (var i = 0; i < ar.length; i++) {
        ...
        temphtml += `
        <div class="dfc dd">
            <input type="checkbox" onchange="change_narrow_json(this,'${_NarrowAreas[index]}')"> ${NarrowAreas[index]}
        </div>`;
    }
